...
const LoginScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../Images/better.png')} />
      <Image source={require('../Images/dotImage.png')} style={styles.logoImage} />
      ...
      <TouchableOpacity style={styles.button} onPress={() => handleOAuth('google')}>
        <Image source={require('../Images/google.png')} style={styles.icon} />
        <Text style={styles.buttonText}>Continue with Google</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => handleOAuth('apple')}>
        <Image source={require('../Images/apple.png')} style={styles.icon} />
        <Text style={styles.buttonText}>Continue with Apple</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.button} onPress={() => handleOAuth('facebook')}>
